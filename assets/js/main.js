!(function ($) {
  ...
  $(document).ready(function () {
    $("#advisor-popup-btn").click(function (e) {
      $("#user-advisor").fadeOut(100);
      $("#advisor-form").delay(100).fadeIn(100);
    });
    $("#user-popup-btn").click(function (e) {
      $("#user-advisor").fadeOut(100);
      $("#user-form").delay(100).fadeIn(100);
    });
    $("#user-form .back-to-select").click(function (e) {
      $("#user-form").fadeOut(100);
      // $("#advisor-form").fadeOut(100);
      $("#user-advisor").delay(100).fadeIn(100);
    });
    $("#advisor-form .back-to-select").click(function (e) {
      // $("#user-form").fadeOut(100);
      $("#advisor-form").fadeOut(100);
      $("#user-advisor").delay(100).fadeIn(100);
    });
    ...
    $('.mobile-nav .get-started').click(function(e){
      $("body").toggleClass("mobile-nav-active");
      $(".mobile-nav-toggle i").toggleClass(
        "icofont-navigation-menu icofont-close"
      );
